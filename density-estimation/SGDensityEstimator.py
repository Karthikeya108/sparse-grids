...
class SG_DensityEstimator:
    def __init__(self, data, gridLevel, regparam, regstr, **kwargs):
        ...
        self.factor_graph.create_factor_graph(3)
    ...
    def calc_model_expected_values(self, iter_step):
        ...
        graph = pm.graph.moral_graph(self.model)
    ...
    def run(self):
        ...
        while likelihood_grad_norm > self.epsilon and iteration_step <= self.imax:
            ...
            ll_list.append(negate_loglike(self.alpha))
            ...
            lgn_list.append(likelihood_grad_norm)
            ...
            self.grid, self.alpha, self.factor_graph, self.alpha_threshold = grid_coarsener.update_grid(self.grid, self.alpha,
                 self.factor_graph, grid_coarsener.coefficient_thresholding, self.alpha_threshold)
            print "curr_grid_size: ", curr_grid_size
            print "self.grid.getSize(): ",self.grid.getSize()
        ...
        print "lgn_list: ", lgn_list
        print "ll_list: ", ll_list
